      ...
      <main>
        <div className="head-title">
          ...
          <div
            ...
            {isOpen && (
              <ul className={`dropdown__list ${isOpen ? 'show' : ''}`}>
                {months.map((month) => (
                  <li
                    key={month}
          ...
          <div className="table-data">
            <div className="order order-product">
              ...
              <table>
                ...
                <tbody>
                  {listProduct
                    .sort((product, sp) => product.quantity - sp.quantity)
                    .slice(0, 10)
                ...
                datasets: [
                  {
                    ...
                    data: [
                      2478, 5267, 734, 784, 433, 10000, 5000, 4000, 3000, 2500,
                      50, 500,
                    ],
                  },
                ],
                ...
                datasets: [
                  {
                    ...
                    data: [50, 10, 100, 1, 5, 25, 100, 125, 30, 80, 90, 100],
                  },
                ],
              }}
              options={{
