...
const Checkout = () => {
  ...
  const handleCheckOut = async (data) => {
    try {
      ...
      const formQuantityDiscount = updateQuantityDiscount(quantityData, idGc);
      await addBillDetail(
            ...
            <div className="checkout-right">
              ...
              {cart.map((item) => (
                <div className="cart-pay-ship">
                  {console.log(item)}
                  <p className="cart-pay-info">{item.name}</p>
                  <p className="cart-pay-price">{item.nameColor}</p>
                  <p className="cart-pay-price">x{item.soluong}</p>
                </div>
              ))}
