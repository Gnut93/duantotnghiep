            ...
            <div className="sg-list">
              <div className="sg-item">
                <div className="sg-content">
                  <p className="sg-desc">
                    {' '}
                    DA xin hướng dẫn cách mua hàng online tại website. Mọi thắc mắc quý khách vui lòng liên hệ số Hotline (+84) 901.379.586 để được tư vấn và giải đáp.
                  </p>
                  <h4 className='sg-title-24'>BƯỚC 1: Truy cập vào website ... Bạn tìm SP mong muốn tại mục SẢN PHẨM hoặc bạn tìm bằng cách Search.</h4>
                  ...
                  <h4 className='sg-title-24'>BƯỚC 2: Sau đó chọn danh mục sản phẩm và sản phẩm bạn muốn mua </h4>
                 ...
                 <h4 className='sg-title-24'>BƯỚC 3: Đầu tiên là chọn số lượng SP muốn mua. Sau đó thêm vào giỏ hàng </h4>
                 ...
                 <h4 className='sg-title-24'>BƯỚC 4: Sau đó vào giỏ hàng để tiếp tục thanh toán </h4>
                 ...
                 <h4 className='sg-title-24'>BƯỚC 5: Nhập thông tin giao hàng và phương thức thanh toán </h4>
                 ...
                 <h4 className='sg-title-24'>BƯỚC 6: Sau khi đặt hàng thành công. Khách hàng có thể theo dõi đơn hàng ở mục THEO DÕI ĐƠN HÀNG </h4>
                ...
                <div className="sg-content">
                  ...
                  <ul className='sg-ul'>
                    <li><Link to="/sg" className='sg-color-black'>● Chính Sách Đổi Hàng Và Đổi</Link></li>
                    <li><Link to="/changegoods" className='sg-color-black'>● Hướng dẫn đổi trả hàng</Link></li>
                    <li><Link to="/trans" className='sg-color-black'>● Chính sách vận chuyển</Link></li>
                    <li><Link to="/quest" className='sg-color-black'>● Câu hỏi thường gặp</Link></li>
                  </ul>
                </div>
              </div>
            </div>
