...
const Navbar = (props) => {
  const {
   backgroundColor = "linear-gradient(to right, #753333ef, #3a0e0ef0)", // Thay đổi giá trị này để thay đổi màu của navbar,
  } = props;
        ...
        <nav className="menu">
          ...
          <ul className="menu-list">
            ...
            {daDangNhap === true ? (
              ...
              <li className="menu-item">
                <Link to="/follow-order" className="menu-link">
                  Theo dõi đơn hàng
                </Link>
              </li>
            )}
          ...
          <ul className="menu-list icon">
              ...
              {daDangNhap && daDangNhap === true ? (
                <>
                  ...
                  <div className="dropdown-content">
                    <Link to="/info-user" className="menu-link">
                      Hồ sơ
                    </Link>
                    <Link to="/follow-order" className="menu-link">
                      Theo dõi đơn hàng
            ...
            <li className="menu-item">
              <Link to="/showCart" className="menu-link">
