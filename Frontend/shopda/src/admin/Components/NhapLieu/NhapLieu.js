                    ...
                    <div className="checkout-address-input checkbox">
                      <div>
                        ...
                        <input
                          ...
                          defaultChecked
                          onChange={(e = 1) =>
                            (sp.hot = e.target.checked ? 1 : 0)
                          }
                        />
                        <label for="switch-hot" className="switch-form"></label>
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          defaultChecked
                          onChange={(e) =>
                            (sp.anhien = e.target.checked ? 1 : 0)
                          }
                        />
                        <label for="switch-an" className="switch-form"></label>
                      </div>
                    </div>
                  </div>
                  <div className="checkout-address-item">
                    ...
                    <div className="checkout-address-input">
                      ...
                      <input
                        ...
                        name="rom"
                        id="laptop-rom"
                        onChange={(e) => (spct.Dia = e.target.value)}
                      />
                    </div>
                    <div className="checkout-address-input">
                      ...
                      <input
                        ...
                        placeholder="KG"
                        id="laptop-kg"
                        onChange={(e) => (spct.Mausac = e.target.value)}
                      />
                    </div>
                    <div className="checkout-address-input">
                      ...
                      <input
                        ...
                        placeholder="Xám"
                        id="laptop-mau"
                        onChange={(e) => (spct.Cannang = e.target.value)}
                      />
                    </div>
                    <div className="checkout-address-input">
                      <input
                ...
                <div className="checkout-address-list">
                  <div className="checkout-address-item">
                    ...
                    <div className="checkout-address-input">
                      ...
                      />
                      <label for="switch-loai" className="switch-form"></label>
                    </div>
                    <div className="checkout-address-input">
                      <button
                        type="button"
