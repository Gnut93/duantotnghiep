...
router.post("/add", async (req, res) => {
    try {
        var { name, description, price, price_sale, image1, image2, image3, color1, color2, color3, color_code1, color_code2, color_code3, quantity, id_cate } = req.body;
        ...
        await queryDB(`INSERT INTO color (id_pd, name, code) VALUES ('${id_pd}', '${color1}', '${color_code1}')`);
        await queryDB(`INSERT INTO color (id_pd, name, code) VALUES ('${id_pd}', '${color2}', '${color_code2}')`);
        await queryDB(`INSERT INTO color (id_pd, name, code) VALUES ('${id_pd}', '${color3}', '${color_code3}')`);
