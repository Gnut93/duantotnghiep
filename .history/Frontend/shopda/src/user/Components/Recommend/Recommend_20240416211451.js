        ...
        <div className="small-container">
          <div className="row">
            ...
            <div className="col-3">
              <i className="ri-chat-quote-fill"></i>
              <p>
                "Shop cung cấp sản phẩm đồ da chất lượng cao và mẫu mã đẹp hợp thời trang! Tôi
                đã mua một chiếc thắt lưng da và tôi rất ưng ý với thiết kế và
                chất liệu. Thắt lưng rất chắc chắn và màu sắc đẹp. Giá cả cũng
                rất hợp lý cho chất lượng sản phẩm. Tôi rất hài lòng và sẽ tiếp
                tục mua hàng tại đây."
              </p>
