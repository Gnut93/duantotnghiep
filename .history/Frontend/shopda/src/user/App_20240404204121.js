    ...
    <div className="wapper">
      ...
      <main className="main">
        <Routes>
          ...
          <Route path="/follow-order" exact element={<FollowOrder />} />
          <Route path="/info-user" exact element={<InforUser />} />
          <Route path="/policy" exact element={<Policy />} />
          <Route path="/quest" exact element={<Questions />} />
          <Route path="/trans" exact element={<Trans />} />
          <Route path="/shopguide" exact element={<ShopGuide />} />
          <Route path="/changegoods" exact element={<ChangeGoods />} />
        </Routes>
      </main>
      <Footer></Footer>
    </div>
